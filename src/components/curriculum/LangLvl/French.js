        ...
        <div className='flex flex-row w-11/12 '>
            <div class="p-4 lg:w-1/4 fadeIN">
                <div class="h-full bg-white drop-shadow-md hover:drop-shadow-xl ease-in duration-300 px-8 pt-16 pb-12 rounded-xl overflow-hidden text-left relative">
                    ...
                    <a href='https://drive.google.com/file/d/1j_6O1oWukf3Q6nSl-pbZBdF1tvKte_2v/view?usp=sharing' class="text-teal-500 hover:text-teal-400 inline-flex items-center">View detailed Curriculum</a>
                </div>
            </div>
            <div class="p-4 lg:w-1/4 fadeIN">
                <div class="h-full bg-white drop-shadow-md hover:drop-shadow-xl ease-in duration-300 px-8 pt-16 pb-12 rounded-xl overflow-hidden text-left relative">
                    ...
                    <a href='https://drive.google.com/file/d/1T42Mv-EZ96IdK5ZgQCkzQmqjL-5aKko5/view?usp=sharing' class="text-teal-500 hover:text-teal-400 inline-flex items-center">View detailed Curriculum</a>
                </div>
            </div>
            <div class="p-4 lg:w-1/4 fadeIN">
                <div class="h-full bg-white drop-shadow-md hover:drop-shadow-xl ease-in duration-300 px-8 pt-16 pb-12 rounded-xl overflow-hidden text-left relative">
                    ...
                    <a href='https://drive.google.com/file/d/1G-Xe3UXs-tG4FKnqKoFz9x0enn3FFiRQ/view?usp=sharing' class="text-teal-500 hover:text-teal-400 inline-flex items-center">View detailed Curriculum</a>
                </div>
            </div>
            <div class="p-4 lg:w-1/4 fadeIN">
                <div class="h-full bg-white drop-shadow-md hover:drop-shadow-xl ease-in duration-300 px-8 pt-16 pb-12 rounded-xl overflow-hidden text-left relative">
                    ...
                    <a href='https://drive.google.com/file/d/1emNH98yEyWPEuLqEcEgdcJR1BCTcDAhz/view?usp=sharing' class="text-teal-500 hover:text-teal-400 inline-flex items-center">View detailed Curriculum</a>
                </div>
            </div>
        </div>
    )
